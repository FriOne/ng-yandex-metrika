...
```
|__bundles/
   |__ng-yandex-metrika.umd.js
   |__ng-yandex-metrika.umd.js.map
   |__ng-yandex-metrika.umd.min.js
   |__ng-yandex-metrika.bundle.min.js.map
|__index.d.ts
|__package.json
|__README.md
|__*.d.ts
|__ng-yandex-metrika.d.ts
|__ng-yandex-metrika.module.d.ts
|__ng-yandex-metrika.es5.js
|__ng-yandex-metrika.es5.js.map
|__ng-yandex-metrika.js
|__ng-yandex-metrika.js.map
|__ng-yandex-metrika.metadata.json
```
